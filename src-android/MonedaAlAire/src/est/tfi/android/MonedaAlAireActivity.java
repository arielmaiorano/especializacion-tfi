...
public class MonedaAlAireActivity extends Activity implements OnClickListener {
	...
	public void resultadoJuego(boolean ganaste, boolean necesito_confirmar)	{
		AlertDialog.Builder builder = new AlertDialog.Builder(this);
		builder.setTitle("Resultado");
		builder.setMessage((ganaste ? "¡GANASTE!" : "¡PERDISTE!") + (necesito_confirmar ? "\n* Se confirmó que la otra parte no hizo trampa" : ""));
