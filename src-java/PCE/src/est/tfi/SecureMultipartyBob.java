	...
	private class InnerTask extends SwingWorker<Void, String> {
		...
		protected Void doInBackground() throws Exception {
			try {
				...
				// esperar conexión (y pedido de llave) de parte de Alice
				...
				// conectar con Carol para pedirle su llave pública
				publish("Conectando con Carol para obtener su llave pública...");
				...
				String cifradoStr = new String(Base64.encode(cifradoBytes),
						"ISO-8859-1");
				publish("Texto cifrado (número + salario) con llave pública de Carol: "
						+ cifradoStr);
				tcp.enviarString(cifradoStr);
				publish("Texto cifrado enviado a Carol.");
