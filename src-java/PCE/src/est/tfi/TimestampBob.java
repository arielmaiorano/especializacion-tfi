...
public class TimestampBob extends JFrame {
	...
	private class InnerTask extends SwingWorker<Void, String> {
		...
		protected Void doInBackground() throws Exception {
			try {
				...
				byte[] hashBytes2 = md2.digest(hashAFecharStr
						.getBytes("ISO-8859-1"));
				...
				byte[] llavePubTrentBytes = Base64.decode(llavePubTrentStr
						.getBytes("ISO-8859-1"));
				...
				publish("Resultado de la comprobación de firma: "
						+ (signature.verify(Base64.decode(strRecibo
								.getBytes("ISO-8859-1"))) ? "VÁLIDA."
								: "INVÁLIDA."));
