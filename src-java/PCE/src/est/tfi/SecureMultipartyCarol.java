...
public class SecureMultipartyCarol extends JFrame {
	...
	public SecureMultipartyCarol() {
		...
		lblDestino = new JLabel(
				"Direcci\u00F3n de Dave (FQDN o direcci\u00F3n IP)");
		...
		lblDestinoPuerto = new JLabel(
				"N\u00FAmero de conexi\u00F3n de Dave (puerto TCP)");
	...
	private class InnerTask extends SwingWorker<Void, String> {
		...
		protected Void doInBackground() throws Exception {
			try {
				...
				// esperar conexión (y pedido de llave) de parte de Bob
				publish("Esperando conexión de Bob...");
				...
				// conectar con Dave para pedirle su llave pública
				publish("Conectando con Dave para obtener su llave pública...");
				...
				// cifrar número con llave pública de Carol
				...
				String cifradoStr = new String(Base64.encode(cifradoBytes),
						"ISO-8859-1");
				publish("Texto cifrado (número + salario) con llave pública de Dave: "
						+ cifradoStr);
				tcp.enviarString(cifradoStr);
				publish("Texto cifrado enviado a Dave.");
