...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		btnAMBAlice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AnonMessBroadAlice tmpFrame = new AnonMessBroadAlice();
				tmpFrame.setVisible(true);
			}
		});
		...
		btnAMBCarol.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AnonMessBroadCarol tmpFrame = new AnonMessBroadCarol();
				tmpFrame.setVisible(true);
			}
		});
		...
		btnAMBBob.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AnonMessBroadBob tmpFrame = new AnonMessBroadBob();
				tmpFrame.setVisible(true);
			}
		});
				...
				JOptionPane
						.showMessageDialog(
								...
								"ESCUELA SUPERIOR TÉCNICA - GRL DIV MANUEL N. SAVIO\n"
										+ "Posgrado de Especialización en Criptografía y Seguridad Teleinformática\n"
										+ "Trabajo Final Integrador (TFI) - \"Protocolos Criptográficos Especiales\" (PCE)\n"
