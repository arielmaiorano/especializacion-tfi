...
public class AnonMessBroadCarol extends JFrame {
	...
	public AnonMessBroadCarol() {
		...
		setResizable(false);
		// título
		setTitle("TFI - PCE - Anonymous Message Broadcast como Carol");
		...
		lblQuienPaga.setBounds(45, 102, 450, 14);
	...
	private class InnerTask extends SwingWorker<Void, String> {
		...
		protected Void doInBackground() throws Exception {
			try {
				...
				// esperar conexión de parte de Bob
				...
				byte[] randomBytesOtro = Principal
						.hexStringToByteArray(randomStrOtro);
				...
				boolean coincidencia = (monedaBobCara && monedaCarolCara) || (!monedaBobCara && !monedaCarolCara);
				...
				tcp.enviarString(coincidencia_bob ? "COINCIDENCIA" : "DIFERENCIA");
